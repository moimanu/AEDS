public class Main {
    ...
    */
    ...
    public static void selectionSort(int[]V, int iMenor, int iMaior) {
        ...
        int possivelMenor = iMenor; //Inicia com uma hipotese

        for(int i = iMenor + 1; i <= iMaior; i++) { //Encontra uma chave menor que a hipotese
        ...
        if (V[iMenor] != V[possivelMenor]) { //Esse codigo é estável, mas a versão clássica não é
            ...
            V[possivelMenor] = aux; //Troca respectivamente
        }
